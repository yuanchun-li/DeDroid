...
class IdentifierMapping(object):
    ...
    """
    def __init__(self, mapping_file=None, recovered_derg=None):
...
def run(mapping_file, recovered_derg, nice2predict_mapping_file, match_mode, report_dir, report_name):
    ...
    if nice2predict_mapping_file is not None:
        nice2predict_mapping_file = os.path.abspath(nice2predict_mapping_file)
        nice2predict = IdentifierMapping(mapping_file=nice2predict_mapping_file)
        nice2predict.update(recover)
        recover = nice2predict
...
def dump_compare_dict(a, b, match_mode, third_party_sigs, report_file, flag="l"):
    ...
    for key in sorted(all_keys):
        ...
        lib_flag = "3LIB" if key in third_party_sigs else "nice"
...
def main():
    ...
    """
    opts = parse_args()
    run(opts.mapping_file, opts.recovered_derg, opts.nice2predict_mapping_file, opts.match_mode, opts.report_dir, opts.report_name)
